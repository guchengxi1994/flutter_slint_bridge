...
class FsbImpl implements Fsb {
  ...
  factory FsbImpl.wasm(FutureOr<WasmModule> module) =>
      FsbImpl(module as ExternalLibrary);
  ...
  Future<void> showAutoCloseDialog({EventMessage? message, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_show_auto_close_dialog(port_, arg0),
      parseSuccessData: _wire2api_unit,
      parseErrorData: null,
...
// Section: api2wire
  ...
  @protected
  ffi.Pointer<wire_EventMessage> api2wire_box_autoadd_event_message(
      EventMessage raw) {
  ...
  @protected
  ffi.Pointer<wire_EventMessage> api2wire_opt_box_autoadd_event_message(
      EventMessage? raw) {
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire___record__i8_i8(
      (int, int) apiObj, wire___record__i8_i8 wireObj) {
    wireObj.field0 = api2wire_i8(apiObj.$1);
    wireObj.field1 = api2wire_i8(apiObj.$2);
  }

  void _api_fill_to_wire_box_autoadd_event_message(
      EventMessage apiObj, ffi.Pointer<wire_EventMessage> wireObj) {
    _api_fill_to_wire_event_message(apiObj, wireObj.ref);
  }

  void _api_fill_to_wire_event_message(
      EventMessage apiObj, wire_EventMessage wireObj) {
...
class FsbWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_show_auto_close_dialogPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_EventMessage>)>>('wire_show_auto_close_dialog');
  late final _wire_show_auto_close_dialog = _wire_show_auto_close_dialogPtr
      .asFunction<void Function(int, ffi.Pointer<wire_EventMessage>)>();
  ...
  late final _new_box_autoadd_event_message_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_EventMessage> Function()>>(
          'new_box_autoadd_event_message_0');
  late final _new_box_autoadd_event_message_0 =
      _new_box_autoadd_event_message_0Ptr
          .asFunction<ffi.Pointer<wire_EventMessage> Function()>();
